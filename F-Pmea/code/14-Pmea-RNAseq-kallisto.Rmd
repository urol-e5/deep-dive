...
Trimmed *P. meandrina RNAseq* reads (found [here](https://gannet.fish.washington.edu/Atumefaciens/20230519-E5_coral-fastqc-fastp-multiqc-RNAseq/P_meandrina/trimmed/))

Transcripts FASTA (found [here](http://cyanophora.rutgers.edu/Pocillopora_meandrina/))
...
```{r download-transcriptome, engine='bash', eval=TRUE}
# Load bash variables into memory
source .bashvars
