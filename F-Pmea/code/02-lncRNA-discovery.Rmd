...
ls ../output/02-lncRNA-discovery/RNA*.gtf
```

![gtf](http://gannet.fish.washington.edu/seashell/snaps/Monosnap_IGV_-_Session_Userssr320DesktopPmea_lncRNA_igv_session.xml_2023-11-05_10-11-31.png)
...
grep -v '^#' ../output/02-lncRNA-discovery/stringtie_merged.gtf | cut -f3 | sort | uniq
