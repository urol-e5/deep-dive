...
output: 
  ...
  html_document:
    ...
    code_folding: show
    code_download: true
bibliography: /home/shared/8TB_HDD_02/shedurkin/deep-dive/F-Pmea/code/references.bib
link-citations: true
---
...
-   *A.millepora* genome FastA. See [12-Apul-sRNAseq-MirMachine.Rmd](https://github.com/urol-e5/deep-dive/blob/main/F-Pmea/code/12-Apul-sRNAseq-MirMachine.Rmd) for download info if needed.
...
mirdeep_result.df <- read.csv("../output/11-Pmea-sRNAseq-miRdeep2/parsable-result_08_11_2023_t_14_47_36.csv",
                              header = TRUE,
                              sep = "\t")
