...
echo 'export transcriptome_fasta_collapsed_name="Porites_evermanni_CDS_collapsed.fasta"'
...
${programs_array[bedtools]} getfasta -fi ${genome_fasta} -bed ${transcriptome_gff} -fo ${transcriptome_fasta}

head ${transcriptome_fasta}
```

```{r format-transcriptome-fasta, engine='bash', eval=TRUE}
# Load bash variables into memory
source .bashvars

# Reformat the transcriptome fasta from a multi-line to a single-line FASTA
${programs_array[fastx_toolkit]}/fasta_formatter \
-i ${transcriptome_fasta} \
-o ${transcriptome_dir}/Peve_1line.fasta

# Look at lines 149 and 150 to confirm they're formatted appropriately
head -n 150 ${transcriptome_dir}/Peve_1line.fasta | tail -n 2
```
...
${programs_array[fastx_toolkit]}/fastx_collapser \
-Q30 \
-i ${transcriptome_dir}/Peve_1line.fasta \
-o ${transcriptome_dir}/Peve_1line_collapsed.fasta

head ${transcriptome_dir}/Peve_1line_collapsed.fasta
```
...
-i ${transcriptome_fasta} \
| ${programs_array[fastx_toolkit]}/fastx_collapser \
-o ${transcriptome_fasta_collapsed}

head ${transcriptome_fasta_collapsed}
```
