...
echo 'export genome_fasta_dir=${deep_dive_dir}/E-Peve/data/Amil/ncbi_dataset/data/GCF_013753865.1'
...
mirdeep_result.df <- read.csv("../output/11-Peve-sRNAseq-miRdeep2/parsable-result_08_11_2023_t_14_47_36.csv",
                              header = TRUE,
                              sep = "\t")
