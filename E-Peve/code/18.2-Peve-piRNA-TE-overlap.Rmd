...
cluster_TEs <- read.table("output/18-Peve-piRNA/2_TE_piRNA_cluster_overlap/PEVE_piRNA_cluster_TEs_intersect.txt")
...
coord_flip() +
  scale_y_continuous(name = "n-fold exnrichment in piRNA clusters", limits = c(-2,5)) +
...
ggsave(filename = paste0("output/18-Peve-piRNA/2_TE_piRNA_cluster_overlap/", my.outprefix,"clusterTE_enrich_plot.png"), fold_TE, width = 3, height = 4)
