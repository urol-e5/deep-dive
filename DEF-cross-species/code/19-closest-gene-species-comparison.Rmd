...
length_plot_mi <- ggplot(count_by_group_mi, aes(x = length, y = n, fill = Species)) + 
  ...
  theme_minimal() + 
  theme(
    axis.title = element_text(size = 75, face = "bold", margin = margin(t = 100, r = 100, b = 100, l = 150)),  # Space between titles and text
    axis.text = element_text(size = 70, colour = "black", margin = margin(t = 10, r = 10, b = 10, l = 10)),  # Axis text size
...
length_plot_pi <- ggplot(combo, aes(x = length, y = sums, fill = Species)) + 
  ...
  theme_minimal() + 
  theme(
    axis.title = element_text(size = 75, face = "bold", margin = margin(t = 100, r = 100, b = 100, l = 100)),  # Space between titles and text
    axis.text = element_text(size = 70, colour = "black", margin = margin(t = 10, r = 10, b = 10, l = 10)),  # Axis text size
    axis.line = element_line(size = 1.5, color = "black"),  # Darker, thicker axis lines
    axis.ticks = element_line(size = 1.5, color = "black"), # Thicker axis ticks
    plot.margin = unit(c(1, 1, 1, 1), "cm"),                # Margin around plot (top, right, bottom, left)
...
length_plot_lnc <- ggplot(length_freq, aes(x = length_bin, y = frequency, fill = Species)) +
  ...
  theme(
    ...
    axis.ticks = element_line(size = 1.5, color = "black"), # Thicker axis ticks
    plot.margin = unit(c(1, 1, 1, 1), "cm"),                # Margin around plot (top, right, bottom, left)
    legend.title = element_text(size = 50, face = "bold"),  # Increase legend title size
...
ggsave(filename = "../figures/ncRNA_lengths.png", plot, width = 65, height = 45, limitsize = F)
ggsave(filename = "../figures/ncRNA_lengths.pdf", plot, width = 65, height = 45, limitsize = F)
```
