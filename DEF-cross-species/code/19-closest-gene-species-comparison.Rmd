...
Filter out extra information from `shared_go_pi_df` and `shared_go_mi_df`
```{r}
...
# Bind dfs together 
all_shared <- rbind(filt_shared_go_pi_df, filt_shared_go_mi_df)

# Save as csv 
write.csv(all_shared, "../output/18-bedtools-closest-gene/ncRNAs_shared_go_by_species.csv")
```
...
ggsave(filename = "../figures/all_ncRNAs_shared_GOs_plot.png", GO_plot_all, width = 35, height = 35)
ggsave(filename = "../figures/all_ncRNAs_shared_GOs_plot.pdf", GO_plot_all, width = 35, height = 35)
```
