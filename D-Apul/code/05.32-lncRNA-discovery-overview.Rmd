...
```{r, engine='bash'}
grep -Fwf ../output/05.32-lncRNA-discovery/Apul_noncoding_transcripts_ids.txt ../output/05.32-lncRNA-discovery/Apul_lncRNA_candidates.fasta > ../output/05.32-lncRNA-discovery/Apul_lncRNAs.txt
```
...
faidx --region-file listofids

```{r, engine='bash', eval=TRUE}
wc -l ../output/05.32-lncRNA-discovery/Apul_lncRNAs.txt
head ../output/05.32-lncRNA-discovery/Apul_lncRNAs.txt
```

```{bash}
awk -F ":" '{print $3 "\t" $4 "\t" $5}' ../output/05.32-lncRNA-discovery/Apul_lncRNAs.txt >
../output/05.32-lncRNA-discovery/Apul_CPT.bed
