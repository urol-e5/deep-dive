...
```{r}
bed <- read.delim2("../output/19-bedtools-closest/miRNA_filtered_Apul_output_overlap.bed", header = F)
head(bed)
```

Format is messed up for the Apul file. There are too many columns and info from the columns is out of order. Need to look into this. 
