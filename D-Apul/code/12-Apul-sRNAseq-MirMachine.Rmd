...
echo 'export genome_fasta="${genome_fasta_dir}/GCF_013753865.1_Amil_v2.1_genomic.fna"'
echo ""
...
--quiet \
--execute robots=off \
--accept "GCF_013753865.1_Amil_v2.1_genomic.fna.gz,md5checksums.txt" ${genome_fasta_url}
