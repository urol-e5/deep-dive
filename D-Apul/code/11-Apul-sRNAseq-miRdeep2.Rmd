...
-   Requires collapsed reads (i.e. concatenated, unique reads) in FastA format. See [10-Apul-sRNAseq-BLASTn.Rmd](https://github.com/urol-e5/deep-dive/blob/main/D-Apul/code/10-Apul-sRNAseq-BLASTn.Rmd) for code.
