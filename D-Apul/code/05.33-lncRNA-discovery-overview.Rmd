---
title: "05.3-Apul-lncRNA-discovery - no splice"
...
```{r, engine='bash', eval=TRUE}
ls ../output/05.33-lncRNA-discovery/*xml
```
...
grep -v '^#' ../output/05.33-lncRNA-discovery/stringtie_merged.gtf | cut -f3 | sort | uniq
